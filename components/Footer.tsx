      ...
      <div className="container">
        <div className="footer-inner">
          ...
          >
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem" }}>
                <a href="mailto:hola@mlgrowth.com.ar" className="footer-link">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                    <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" stroke="currentColor" strokeWidth="1.8" />
                    <path d="M22 6l-10 7L2 6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
                  </svg>
                  hola@mlgrowth.com.ar
                </a>
                <a href="https://wa.me/549XXXXXXXXXX" target="_blank" rel="noreferrer" className="footer-link">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
          ...
          >
            ...
            >
              © {year} ML Growth · Todos los derechos reservados
            </p>
