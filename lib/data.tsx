...
export const tiers = [
  {
    id: "starter",
    name: "OPERACIÓN",
    description: "La operación diaria de tu cuenta, bajo control.",
    range: "$10M – $20M / mes",
    price: "USD 800/mes",
    featured: false,
    features: [
  ...
  },
  {
    id: "growth",
    name: "GROWTH",
    description: "Publicidad, precios y logística para impulsar tus ventas.",
    range: "$20M – $70M / mes",
    price: "USD 1.500/mes",
    featured: true,
    features: [
  ...
  },
  {
    id: "scale",
    name: "ESCALA",
    description: "Rentabilidad y planificación para dirigir el crecimiento de tu negocio.",
    range: "+$70M / mes",
    price: "USD 3.000/mes",
    featured: false,
    features: [
      "Todo lo del plan Growth",
      "Responsable de cuenta asignado",
      "Análisis de rentabilidad por SKU",
      "Proyección de demanda y planificación de stock",
      "Estrategia de catálogo y oportunidades de expansión",
      "Plan comercial y reunión estratégica mensual",
      "Soporte prioritario",
    ],
    ctaVariant: "ghost" as const,
  },
